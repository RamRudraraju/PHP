...
<?php
  ...
  echo 'SID: ' . SID . '<br><br>';
  echo "<a href=\"/course/Example23-sessionsWithoutCookies-page3.php\"> Next page </a><br>";
  echo "<a href=\"/course/Example23-sessionsWithoutCookies-page1.php\"> Previous page </a><br>";
?>
