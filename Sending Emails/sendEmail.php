...
<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_error_msg) && empty($email_error_msg) &&
      ...
      // Send an email to the realtor so the request can be processed.
      // NOTE: Change this "to" address to one which you can access to
      // see if the email has been sent
      $to = "realtor@somerealtor.com";
      $subject = "You request has been registered with the realtor!";
      $message = "Name: $name \nEmail: $email \nPhone: $phone \nProperty: $property";
      $headers = array(
         // Change this email address to the from account you set up
         // while configuring your email
         "From: youremailaccount@gmail.com",
         "Reply-To: youremailaccount@gmail.com",
         "Cc: " . $email,
